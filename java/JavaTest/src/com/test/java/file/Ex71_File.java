...
public class Ex71_File {
	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  파일 입출력 
		  - 자바프로그램 -> 데이터 -> 메모리(주기억장치) -> 휘발성(전원 공급 + 데이터 유지)
		  - HDD,SSD,USB Memory(보조기억장치) -> 영구성 (전원 공급 무관 + 데이터 유지)
		  - 자바프로그램 <-> (데이터) <-> 보조 기억장치 
		   ...
		   1. 텍스트 입출력 
		     ...
		     - 메모장
		     - 수업
		     -"홍길동" -> (변환) -> 1010101101010111010101 // 파일쓰기
		     - 1010101101010111010101 -> (변환) -> "홍길동"// 파일읽기
		   2. 바이너리 입출력 
...
//		m2();
	...
	try {
			...
			BufferedReader reader = new BufferedReader(new FileReader("C:\\class\\java\\JavaTest\\src\\com\\test\\java\\file\\Ex69_File.java"));
			
			String line ="";
			int n = 1;
			
			while((line = reader.readLine()) != null) {
				System.out.printf("03%d: %s\n",n, line);
				n++;
			}
	...
	private static void m5() {
		try {
		FileReader reader = new FileReader("C:\\class\\java\\JavaTest\\src\\com\\test\\java\\file\\Ex69_File.java");
