...
public class Ex47_final {
	public static void main(String[] args) {
		...
		System.out.println(f1.D); // 공용정보 -> 다른 객체와 다른 값을 가질 수 없다. -> 모두 같은값 
		
		FinalItem f2 = new FinalItem();
		System.out.println(f2.C); // 개인정보 다른 객체와 다른 값을 가질 수 있다.  
		System.out.println(f2.D); // 공용정보 다른 객체와 다른 값을 가질 수 없다. -> 모두 같은값 
...
// -> 더이상 자식을 가질 수 없는 클래스 -> 최종 ㅋ클래스(Leaf Class)
