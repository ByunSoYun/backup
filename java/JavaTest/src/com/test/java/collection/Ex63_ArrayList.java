...
//		}
		...
		//괄호에 넣는 숫자의 배열부터 시작이 된다 밑의 뻘짓 안해도된다  //처음부터 1025칸짜리 배열로 시작 -> 비용 대폭 감소 
		//4칸 배열(initial capacity )
...
//		
//			
//			//4 -> 8 ->8칸짜리 배열 생성 비용 발생 + 복사비용 발생 + 4칸짜리 배열쓰레기 처리 비용 발생
//			//8 -> 16
//			//16 -> 32
//			//32 -> 64
//			//64 -> 128
