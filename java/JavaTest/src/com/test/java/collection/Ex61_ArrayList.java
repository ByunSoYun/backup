...
public class Ex61_ArrayList {
	...
	// - 순수 배열의 요소는 삭제 불가능 
	// - 컬렉션은 요소의 삭제 가능 
	// - T remove(int index) //  더 많이 사용//조심!! 대상의 방 뒤에있는 방들이 하나씩 댕겨짐
	...
	// - 삽입(Insert)
	// - 중간에 끼워넣기 
	//- void add(int index, T value) //대상의 방 뒤에있는 방들이 하나씩 밀려남 
...
//	주황
	...
	System.out.println(list.indexOf("노랑"));//몇번쨰? 방향(->)
	System.out.println(list.indexOf("노랑"));
	System.out.println(list.lastIndexOf("노랑"));// 몇번쨰? 방향(<-)
	...
	List<String>a2 = new ArrayList<String>(); // 부모인터페이스 =자식객체 //업케스트
	...
	private static void m1() {
		...
		//컬렉션 
		//ArrayList
		// - 타입 없음 (자료형) (int) -> Object 배열 
		// - 길이 없음(3)  -> 가변 (늘리거나 줄일 수 있다) *******************************
		ArrayList num2 = new ArrayList();
		ArrayList<Integer>num3 = new ArrayList<Integer>();
	
		//초기화 
		//num2[0] = 100;//[0] : Indexer -> 자바는 순수배열만 인덱서를 지원한다.
