...
public class Ex07_DataType {
	public static void main(String[] args) {
		...
		int a = 10;
		int b = 20;
		//변수가 문자내에 있으면 변수가 아닌 그냥 단순한 문자열로 취급
	...
	//---------------------------------------------------------
		...
		//**** 주민등록번호는 숫자가 아니다!!!  -> 연산 안쓸거면 String으로 표현!!!!
		jumin = 030510; //12616   <- 8진수로 생각돼서 10진수 값이 나옴
		System.out.println("주민번호: "+ jumin );
