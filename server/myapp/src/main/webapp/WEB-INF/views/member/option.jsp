...
<body>
	<!-- views > member > login.jsp > option.jsp -->
	...
	<script>
		...
		// - 한번 저장 > 모든 페이지 접근 가능(***)
		// - 사용자 임의 삭제 가능(***) > 중요한 데이터는 쿠키에 저장하지 말것!!!
		
		//*** session
		// - 개인 설정 저장
		// - 장소(X) > 현재 접속중일때만 사용 가능
		// - 중요한 데이터를 저장 > 사용자 임의 삭제 불가능 > 서버 프로그램을 통해서만 삭제 가능
		// - 영구 보관 불가능(***)
		
		//*** DB
		// - 개인 설정 저장
		// - 장소 불문 > 어디서든 어떤 PC 사용하던 모두 지속적 접근 가능
		// - 중요한 데이터 저장
		// - 영구 보관 가능
		// - 고비용(***)
