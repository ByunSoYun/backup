...
public class Ex04 {
   ...
   public static void main(String[] args) {
      ...
      //함수형 인터페이스, Functional Intetface
      // - 람다식과 함께 자바 8부터 지원(JDK 1.8)
      // - 개발자가 직접 정의(*)
      // - JDK에서도 많은 수의 함수형 인ㅌ페이스를 제공(***)
      ...
      // 3. Function: 매개변수O, 반환값O, 매개변수를 반환값으로 변환 후 반한
      //      - Function<T>
      //      - BiFunction<T, R>
      ...
      // 5. Predicate: 매개변수O, 반환값O, 매개변수를 논리 연산 후 결과 반환, Fucntion 하위 버전
      //      - Predicate<T>
   ...
   private static void m7() {
      ...
      java.util.function.Predicate<Integer> p1 = num -> num > 0;
   ...
   private static void m6() {
      ...
      Consumer<Integer> c1 = num -> System.out.println(num > 0 ? "양수" : "음수");
      c1.accept(n);
      ...
      java.util.function.Predicate<Integer> p3 = p1.and(p2);
      System.out.println(p3.test(6));
      System.out.println(p3.test(5));
      System.out.println();
      
      java.util.function.Predicate<Integer> p4 = p1.or(p2);
      System.out.println(p4.test(2));
      System.out.println(p4.test(3));
      System.out.println(p4.test(5));
      System.out.println();
      
      java.util.function.Predicate<Integer> p5 = p1.negate();
      System.out.println(p5.test(5));
      System.out.println(p5.test(5));
      System.out.println(p5.test(5));
   ...
   private static void m5() {
      ...
      System.out.println(bp1.test(1, 5));
      System.out.println(bp1.test(5, 1));
   ...
   private static void m4() {
      ...
      // 4. Operator: 매개변수O, 반환값O, 매개변수를 연산 후 결과 반환, Function 하위 버전
      // - 매개변수의 값을 받아 연산 처리를 한 후 반환값을 돌려주는 역할
      // - applyXXX()
      // - Operator는 Function과 다르게 매개변수의 타입과 반환값의 타입이 동일하다.(연산자들이 보통 이런 성질을 가지기 때문에.. 흉내)
   ...
   private static void m2() {
      ...
      //실행문에 return문만 존재하면 {} 생략 + return 생략
   ...
   private static void m1() {
      ...
      // - void accept(String, Integer) > 람다식 만든다.
