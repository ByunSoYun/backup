...
//                 }
                 ...
                 if (n == 1) {
                    ...
                    if (map.get("isSearch").equals("y")) 
                          ...
                          pagebar += pagebar += String.format(" <li><a href='/webproject/main/member/community/itevent.do?page=%d&column=%s&search=%s&isSearch=%s' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span></a></li> ", n - 1, column, search, isSearch);
                          
                    } else if (map.get("isSearch").equals("n")) {
                       
                       if (map.get("orderRegdate") != null && map.get("orderRegdate").equals("regdate")) {
                          
                          pagebar += pagebar += String.format(" <li><a href='/webproject/main/member/community/itevent.do?page=%d&orderRegdate=regdate' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span></a></li> ", n - 1);
                          
                       } else if (map.get("orderRecommendCount") != null && map.get("orderRecommendCount").equals("recommendCount")) {
                          
                          pagebar += pagebar += String.format(" <li><a href='/webproject/main/member/community/itevent.do?page=%d&orderRecommendCount=recommendCount' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span></a></li> ", n - 1);
                          
                       } else if (map.get("orderComment") != null && map.get("orderComment").equals("ccnt")) {
                          
                          pagebar += pagebar += String.format(" <li><a href='/webproject/main/member/community/itevent.do?page=%d&orderComment=ccnt' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span></a></li> ", n - 1);
                          
                       } else if (map.get("orderReadCount") != null && map.get("orderReadCount").equals("readCount")) {
                          
                          pagebar += pagebar += String.format(" <li><a href='/webproject/main/member/community/itevent.do?page=%d&orderReadCount=readCount' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span></a></li> ", n - 1);
                          
                       } else if (map.get("orderRegdate") == null && map.get("orderRecommendCount") == null && map.get("orderComment") == null && map.get("orderReadCount") == null) {
                          
                          pagebar += pagebar += String.format(" <li><a href='/webproject/main/member/community/itevent.do?page=%d' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span></a></li> ", n - 1);
